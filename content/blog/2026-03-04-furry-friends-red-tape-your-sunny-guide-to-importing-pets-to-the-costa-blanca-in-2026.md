...
1. The "EU Passport" Crackdown: If you live in Great Britain (England, Scotland, Wales), you can no longer use an EU Pet Passport (even one issued in Spain) to leave the UK. You MUST have a UK-issued Animal Health Certificate (AHC). EU Passports are now strictly for EU residents only.
2. The 5-Pet Limit: The limit is now 5 pets per private vehicle, not per person. If you are travelling with more than 5 animals in one car, you are now legally classed as "commercial travel" (much stricter and more expensive).
3. Stricter Verification: Border officials at Spanish ports and airports have been instructed to conduct 100% document checks on all pets arriving from the UK to ensure the new welfare and traceability standards are met.

**Part 1: Travelling from the UK to Spain**

Since the UK is a "non-EU" country, you need to prepare well in advance.

###### **Essential Requirements:**

* Microchip: Must be ISO-compliant. This must be done before or on the same day as the rabies jab.
...
**Part 2: Travelling from Spain back to the UK**

Coming home is generally simpler, but the timing is everything for dog owners.

**Essential Requirements:**

* Document: You can use your original AHC (if within 4 months of issue) OR a valid EU Pet Passport (issued in Spain). Unlike the outbound journey, the UK still accepts EU passports for entry.
* Tapeworm Treatment (Dogs Only): This is the one that trips people up! A vet in Spain must administer a tapeworm treatment (Praziquantel) 24 to 120 hours (1–5 days) before you arrive at the UK border.
* No AHC Required: If you have a valid EU Pet Passport, you don’t need a new AHC to enter the UK from Spain.

**Practical Tips for 2026**

* Book Early: Vets are seeing a surge in AHC requests due to the new April rules. Book your appointment at least 6 weeks before you travel.
* For Costa Blanca Expats: If you spend more than 6 months a year in Spain and have a TIE/Residency, get a Spanish vet to issue an EU Pet Passport. It costs €45–€100 and makes travelling *within* the EU a breeze—but remember, if you move back to the UK, you'll go back to needing an AHC to visit Spain!
* Airline Rules: Most airlines flying into Spain (like Ryanair or EasyJet) do not allow pets in the cabin. You will likely need to use a specialised pet courier or take the ferry/Eurotunnel.

**Final Tail-Wagging Advice**

Pet travel rules are like Costa Blanca weather—mostly sunny, but a random storm can change the plan fast! If your paperwork is wrong, your pet could face quarantine or be refused entry.
