...
1. Secure legal residency: Obtain your NIE (foreigner ID) and register on the local padrón at the town hall.
2. Prove eligibility: Common routes include working/self-employment (contributing to social security), UK state pensioners using an S1 form (transfers your UK entitlement — very popular with retirees), or family connections. 
